...
const routes = [
    ...
    {
        path: 'chats',
        loadChildren: () => Promise.all(/*! import() | pages-chats-chats-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-chats-chats-module")]).then(__webpack_require__.bind(null, /*! ./pages/chats/chats.module */ "./src/app/pages/chats/chats.module.ts")).then(m => m.ChatsPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]]
    },
    {
        path: 'chats/start',
        loadChildren: () => Promise.all(/*! import() | pages-start-chat-start-chat-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-start-chat-start-chat-module")]).then(__webpack_require__.bind(null, /*! ./pages/start-chat/start-chat.module */ "./src/app/pages/start-chat/start-chat.module.ts")).then(m => m.StartChatPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]]
    },
    {
        path: 'chat/:id',
        loadChildren: () => Promise.all(/*! import() | pages-chat-chat-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-chat-chat-module")]).then(__webpack_require__.bind(null, /*! ./pages/chat/chat.module */ "./src/app/pages/chat/chat.module.ts")).then(m => m.ChatPageModule),
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]]
    },
    {
        path: 'profile',
...
/* harmony import */ var _ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ionic-native/firebase/ngx */ "./node_modules/@ionic-native/firebase/__ivy_ngcc__/ngx/index.js");
...
let AuthGuard = class AuthGuard {
    ...
    canActivate() {
        return this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(user => !!user), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(authenticated => {
            if (!authenticated) {
...
AuthGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__["AngularFireAuth"]])
], AuthGuard);
...
let AuthService = class AuthService {
    constructor(afAuth, db) {
        ...
        this.afAuth.authState.subscribe(res => {
            ...
            if (this.user) {
                ...
                this.db.doc(`users/${this.currentUserId}`).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(res => {
    ...
    isNicknameAvailable(name) {
        return this.db.collection('users', ref => ref.where('nickname', '==', name).limit(1)).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(user => {
            return user;
        }));
    }
    signIn(credentials) {
...
AuthService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"]])
], AuthService);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic-native/firebase/ngx */ "./node_modules/@ionic-native/firebase/__ivy_ngcc__/ngx/index.js");
...
FcmService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_4__["Firebase"],
...
module.exports = __webpack_require__(/*! /Users/tejasramani/Other-webdev/ionic/ionic-firebase-chat-v2/src/main.ts */"./src/main.ts");
