...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("common"), __webpack_require__.e("pages-chats-chats-module")]).then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-start-chat-start-chat-module */
        [__webpack_require__.e("common"), __webpack_require__.e("pages-start-chat-start-chat-module")]).then(__webpack_require__.bind(null,
        /*! ./pages/start-chat/start-chat.module */
        "./src/app/pages/start-chat/start-chat.module.ts")).then(function (m) {
          return m.StartChatPageModule;
        });
      },
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__["AuthGuard"]]
    }, {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_fcm_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function notificationSetup() {
          var _this2 = this;

          this.fcm.getToken();
          this.fcm.onNotifications().subscribe(function (msg) {
            if (msg.tap >= 1) {
              _this2.router.navigateByUrl("/chat/".concat(msg.chat));
            } else {
              if (_this2.platform.is('ios')) {
                _this2.presentAlert(msg.aps.alert, msg.chat);
              } else {
                _this2.presentAlert(msg, msg.chat);
              }
            }
          });
        }
        ...
        key: "presentAlert",
        value: function presentAlert(info, chat) {
                    ...
                    return this.alertCtrl.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          _this3.router.navigateByUrl("/chat/".concat(chat));
                        }
                      }]
                    });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! @ionic-native/firebase/ngx */
    "./node_modules/@ionic-native/firebase/__ivy_ngcc__/ngx/index.js"); // import { AngularFirestoreModule, FirestoreSettingsToken } from '@angular/fire/firestore';


    var CameraMock = /*#__PURE__*/function () {
      function CameraMock() {
        _classCallCheck(this, CameraMock);
      }

      _createClass(CameraMock, [{
        key: "getPicture",
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_9__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].firebase), _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_11__["AngularFirestoreModule"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_12__["AngularFireAuthModule"], // FirestoreSettingsToken,
      ...
      _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_14__["Camera"], //  { provide: Camera, useClass: CameraMock },
  ...
  function srcAppGuardsAuthGuardTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthGuard = /*#__PURE__*/function () {
      ...
      _createClass(AuthGuard, [{
        ...
        value: function canActivate() {
          ...
          return this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (user) {
            return !!user;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (authenticated) {
            if (!authenticated) {
    ...
    AuthGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__["AngularFireAuth"]])], AuthGuard);
    /***/
  },
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthService = /*#__PURE__*/function () {
      function AuthService(afAuth, db) {
        ...
        this.afAuth.authState.subscribe(function (res) {
          ...
          if (_this5.user) {
            console.log('authenticated user: ', _this5.user);

            _this5.db.doc("users/".concat(_this5.currentUserId)).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (res) {
              _this5.nickname = res['nickname']; // console.log(this.nickname);
            })).subscribe();
          }
        });
      }
      ...
      _createClass(AuthService, [{
        key: "ngOnInit",
        value: function ngOnInit() {// this.nickname2 = this.db.doc(`users/${this.currentUserNickName}`).snapshotChanges();
        ...
        value: function signUp(credentials) {
          ...
          return this.afAuth.createUserWithEmailAndPassword(credentials.email, credentials.password).then(function (data) {
            ...
            return _this6.db.doc("users/".concat(data.user.uid)).set({
        ...
        key: "isNicknameAvailable",
        value: function isNicknameAvailable(name) {
          return this.db.collection('users', function (ref) {
            return ref.where('nickname', '==', name).limit(1);
          }).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (user) {
            return user;
          }));
        }
      }, {
        ...
        key: "updateUser",
        value: function updateUser(nickname) {
          return this.db.doc("users/".concat(this.currentUserId)).update({
            nickname: nickname
          });
        }
      }, {
    ...
    AuthService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_3__["AngularFirestore"]])], AuthService);
    /***/
  },
  ...
  function srcAppServicesFcmServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @ionic-native/firebase/ngx */
    "./node_modules/@ionic-native/firebase/__ivy_ngcc__/ngx/index.js");
    /* harmony import */


    var _ionic_angular__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @ionic/angular */
    "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js"); // https://medium.freecodecamp.org/how-to-get-push-notifications-working-with-ionic-4-and-firebase-ad87cc92394e
    ...
    var FcmService = /*#__PURE__*/function () {
      ...
      _createClass(FcmService, [{
        ...
        key: "onNotifications",
        value: function onNotifications() {
    ...
    FcmService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Injectable"])({
      providedIn: 'root'
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_native_firebase_ngx__WEBPACK_IMPORTED_MODULE_4__["Firebase"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["Platform"], src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"]])], FcmService);
    /***/
  },
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var environment = {
      ...
      firebase: {
        ...
        databaseURL: "https://ionic-firebase-chat-30bd6.firebaseio.com",
        projectId: "ionic-firebase-chat-30bd6",
        storageBucket: "ionic-firebase-chat-30bd6.appspot.com",
        messagingSenderId: "626791980154",
        appId: "1:626791980154:web:adab2c454e01e4d8516fc3",
        measurementId: "G-WRBQH3QQFW"
      }
    };
    /*
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/tejasramani/Other-webdev/ionic/ionic-firebase-chat-v2/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
